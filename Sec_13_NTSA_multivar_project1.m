...
%      VIDEO: Project 6-1: GED for interacting alpha sources
...
% initialize covariance matrices (R: full data; S: filtered data)
...
for fi=1:length(frex)
    ...
    % compute synchronization (ISPC) and average power
...
top8 = V(:,1:8)'*reshape(EEG.fdata(1:EEG.nbchan,:,:),EEG.nbchan,[]);

% extract amplitude time series
top8 = abs(hilbert( top8' ).');
