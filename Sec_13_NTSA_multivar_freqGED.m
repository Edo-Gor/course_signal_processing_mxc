...
% filter the data in broad alpha (center,fwhm)
EEG.fdata = filterFGx(EEG.data,EEG.srate,11,7,1);

% wide time window (same for both S and R)
tidx = dsearchn(EEG.times',[ 0 2 ]');

% initialize covariance matrices (S is the narrowband and R is the entire signal)
