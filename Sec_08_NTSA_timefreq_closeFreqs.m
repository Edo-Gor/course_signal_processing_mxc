...
%
%% On how close features in the frequency domain are difficult to disentangle with TF analyses
...
% Gaussian parameter (in seconds); peaktimes slightly shifted
fwhm = .3;
ptime1 = 1;
ptime2 = 1.1;
...
legend({'signal 1';'signal i2'})

% and the final signal
subplot(212)
plot(timev,signal,'k','linew',2)
xlabel('Time (s)'), ylabel('Amp. (a.u.)')
legend('sum of 2 signals')
...
title(['Wavelet deconvolution with FWHM = ' num2str(wavefwhm) ])
colormap jet
