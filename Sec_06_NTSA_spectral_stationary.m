...
% ampmod  = (1+sin(2*pi*t*1))/2;  % uncomment to further explore effects of amplitude nonstationarities
...
set(gca,'xlim',[0 20])
title('Frequency domain')
% title('Frequency domain (notice the modulator frequencies aroud the carrier wave)')
legend({'Nonstationary';'Stationary'})
